...
use App\Http\Controllers\staff\StaffReportController; // Pastikan untuk mengimpor controller laporan staff
...
Route::prefix('staff')->name('staff.')->group(function () {
    ...
    Route::get('reports', [StaffReportController::class, 'index'])->name('reports.index'); // Tambahkan rute untuk laporan staff
});
